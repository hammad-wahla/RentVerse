    ...
    <div className="space-y-16">
      ...
      <section className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-secondary-900 dark:text-white">Start Investing in Minutes</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="bg-white dark:bg-secondary-800 p-6 rounded-lg shadow-md text-center border border-transparent dark:border-secondary-700">
                <div className="bg-primary-50 dark:bg-secondary-700/50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      {/* How It Works */}
      <section className="bg-secondary-900 dark:bg-slate-950 text-white py-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How RentVerse Works</h2>
            <p className="text-secondary-300 dark:text-secondary-400">Understanding our tokenized real estate platform</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorks.map((item, index) => (
              <motion.div
                key={index}
                className="bg-secondary-800 dark:bg-secondary-900 p-6 rounded-lg border border-transparent dark:border-secondary-800"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.2 }}
              >
                ...
                <p className="text-secondary-300 dark:text-secondary-400 text-center">{item.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-secondary-900 dark:text-white">Featured Investment Opportunities</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredProperties.map((property, index) => (
            <motion.div
              key={property.id}
              className="card group bg-white dark:bg-secondary-800 border border-transparent dark:border-secondary-700"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ delay: index * 0.2 }}
            >
              <div className="relative h-48">
                ...
                />
                <div className="absolute top-4 right-4 bg-white dark:bg-secondary-800 text-primary-600 dark:text-primary-300 px-3 py-1 rounded-full font-semibold shadow">
                  {property.status}
                </div>
              </div>
              <div className="p-6">
      ...
      {/* Why Choose Us */}
      <section className="bg-secondary-50 dark:bg-secondary-900/50 pt-16 pb-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-secondary-900 dark:text-white">Why Choose RentVerse</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {advantages.map((advantage, index) => (
              <motion.div
                key={index}
                className="bg-white dark:bg-secondary-800 p-6 rounded-lg shadow-md text-center border border-transparent dark:border-secondary-700"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ delay: index * 0.2 }}
      ...
      <section className="container">
        <div className="bg-primary-600 rounded-2xl p-8 md:p-12 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/properties"
              className="btn bg-white dark:bg-secondary-800 text-primary-600 dark:text-primary-300 hover:bg-primary-50 dark:hover:bg-secondary-700"
            >
              Browse Properties
            </Link>
            {isInitializing ? (
              <div className="btn bg-primary-700 opacity-60 pointer-events-none flex items-center justify-center">
                <FaWallet className="mr-2 animate-pulse" />
                Connecting...
              </div>
            ) : isConnected ? (
              <button
      ...
      <div className="container bg-white dark:bg-secondary-900 py-24">
        ...
        >
          <h1 className="text-3xl font-bold mb-4 text-secondary-900 dark:text-white">Latest Insights</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-white dark:bg-secondary-800 rounded-lg shadow-md overflow-hidden border border-transparent dark:border-secondary-700"
            >
              <Link to={`/blog/${post.slug}`}>
                <div className="relative h-48">
                  <img
                    ...
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute top-4 right-4 bg-white dark:bg-secondary-800 px-3 py-1 rounded-full text-sm font-medium text-primary-600 dark:text-primary-300 shadow">
                    {categories.find(c => c.id === post.category)?.name}
                  </div>
                </div>
                <div className="p-6">
                  <h2 className="text-xl font-semibold mb-3 text-secondary-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    {post.title}
                  </h2>
      ...
      <section className="container">
        ...
        >
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-secondary-900 dark:text-white">Frequently Asked Questions</h2>
          ...
          <div className="space-y-8">
            {faqSections.map((section, sectionIndex) => (
              <div key={sectionIndex} className="bg-white dark:bg-secondary-800 rounded-lg shadow-md overflow-hidden border border-transparent dark:border-secondary-700">
                    ...
                    <div key={questionIndex} className="p-6">
                      ...
                      >
                        ...
                        {openSections[`${section.title}-${questionIndex}`] ? (
                          <FiChevronUp className="flex-shrink-0 ml-4 text-secondary-600 dark:text-secondary-400" />
                        ) : (
                          <FiChevronDown className="flex-shrink-0 ml-4 text-secondary-600 dark:text-secondary-400" />
                        )}
                      </button>
                      <AnimatePresence>
                        {openSections[`${section.title}-${questionIndex}`] && (
      ...
      {/* Discord CTA */}
      <section className="py-12 bg-primary-900 dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full dark:bg-secondary-800 border border-transparent dark:border-secondary-700">
                ...
                <p className="mt-4 text-sm text-gray-500 text-center dark:text-secondary-400">
                  Already a member?{' '}
                  <a href="https://discord.gg/RentVerse" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
                    Sign in
                  </a>
                </p>
              </div>
